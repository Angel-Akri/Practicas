...
// Clase principal del juego de damas (consola)
class Damas
{
    ...
    // indica los bandos de las fichas o sea roja o negra (cafe), o "" si la casilla no tiene una ficha
    ...
    // Valida y ejecuta un movimiento (simple, captura o coronación)
